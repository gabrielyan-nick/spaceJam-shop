      ...
      <div className="relative h-[27px]">
        ...
        {isShow && (
          <div
            ref={ref}
            className={cn(
              'pt-1 pb-2 pl-2 pr-1 animate-open absolute min-w-[220px] w-max max-w-[300px] sx:max-w-[310px] min-h-[100px] top-[40px] rounded-lg -right-[105px] sxx:-right-[110px] smm:-right-3 bg-popupBg shadow-[#0000004f] shadow-md',
            )}
          >
